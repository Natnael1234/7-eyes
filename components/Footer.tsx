...
export default function Footer({ email, phone, address, facebook, instagram, linkedin }: FooterProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex space-x-4">
              {facebook && (
                <Link href={facebook} target="_blank" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-primary hover:scale-110 transition-all duration-300 group">
              ...
              {instagram && (
                <Link href={instagram} target="_blank" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-secondary hover:scale-110 transition-all duration-300 group">
              ...
              {linkedin && (
                <Link href={linkedin} target="_blank" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-blue-500 hover:scale-110 transition-all duration-300 group">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-4 mb-6 text-gray-400">
              <p className="flex items-start gap-3">
                ...
                <span>{address || 'Megenagna, Addis Ababa, Ethiopia'}</span>
              </p>
              <p className="flex items-center gap-3">
                ...
                <span>{email || 'info@seveneyes.com'}</span>
              </p>
            </div>
            {/* Google Map */}
