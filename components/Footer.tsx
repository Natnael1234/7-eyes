    ...
    <footer className="bg-black text-white pt-20 pb-10 border-t border-white/10">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            <h3 className="text-2xl font-bold font-display mb-6">Seven Eyes</h3>
            <p className="text-gray-400 mb-6">
              Empowering Stories, Empowering Community. Impactful Experiences, Meaningful Change.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-secondary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li><Link href="#" className="hover:text-brand-primary transition-colors">Media Production</Link></li>
              <li><Link href="#" className="hover:text-brand-primary transition-colors">Event Management</Link></li>
              <li><Link href="#" className="hover:text-brand-primary transition-colors">Digital Marketing</Link></li>
              <li><Link href="#" className="hover:text-brand-primary transition-colors">Consultancy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li><Link href="#" className="hover:text-brand-primary transition-colors">Our Team</Link></li>
